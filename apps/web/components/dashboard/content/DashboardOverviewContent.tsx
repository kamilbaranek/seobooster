...
import useToolbarDropdowns from '../hooks/useToolbarDropdowns';
import useCharts from '../hooks/useCharts';

const DashboardOverviewContent = () => {
  const contentRef = useRef<HTMLDivElement | null>(null);
  useToolbarDropdowns(contentRef);
  useCharts(contentRef);
                ...
                <div className="card card-flush" style={{background: 'linear-gradient(180deg, #1858FD 0%, #1652EA 100%)', boxShadow: '0px 14px 40px 0px rgba(24, 85, 243, 0.20)'}}>
                  ...
                  <div className="card-header align-items-center pt-6">
                    ...
                    <div className="symbol symbol-50px me-4">
                      <div className="symbol-label bg-transparent rounded-lg" style={{border: '1px dashed rgba(255, 255, 255, 0.20)'}}>
                        <i className="ki-outline ki-handcart text-white fs-1" />
                      </div>
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Info*/}
                    <div className="card-title flex-column flex-grow-1">
                      <span className="card-label fw-bold fs-3 text-white">New Orders</span>
                  ...
                  <div className="card-body d-flex align-items-end pb-0">
                    ...
                    <div className="d-flex flex-stack flex-row-fluid">
                      ...
                      {/*end::Block*/}
                      {/*begin::Chart*/}
                      <div id="kt_charts_widget_47" className="h-125px w-200px min-h-auto" />
                      {/*end::Chart*/}
                    </div>
                    {/*end::Wrapper*/}
                  </div>
                ...
                <div className="card card-flush">
                  ...
                  <div className="card-header justify-content-start align-items-center pt-6">
                    ...
                    <div className="symbol symbol-50px me-4">
                      <div className="symbol-label border border-dashed border-gray-300">
                        <i className="ki-outline ki-handcart text-info fs-1" />
                      </div>
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Info*/}
                    <div className="card-title flex-column flex-grow-1">
                      <span className="card-label fw-bold fs-3 text-gray-800">New Orders</span>
                  ...
                  <div className="card-body d-flex align-items-end pb-0">
                    ...
                    <div className="d-flex flex-stack flex-row-fluid">
                      ...
                      {/*end::Wrapper*/}
                      {/*begin::Chart*/}
                      <div id="kt_charts_widget_48" className="h-125px w-200px min-h-auto" />
                      {/*end::Chart*/}
                    </div>
                    {/*end::Wrapper*/}
                  </div>
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <div className="d-flex justify-content-start flex-column">
                              <a href="#" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
                        ...
                        <td className="text-end pe-12">
                          ...
                          <span className="badge badge-light-success fs-base">
                            <i className="ki-outline ki-arrow-up fs-5 text-success ms-n1" />9.2%</span>
                          {/*end::Label*/}
                        </td>
                        <td className="text-end pe-0">
                          <div id="kt_table_widget_15_chart_1" className="h-50px mt-n8 pe-7" data-kt-chart-color="success" />
                        </td>
                        <td className="text-end">
                          <a href="#" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                            <i className="ki-outline ki-black-right fs-2 text-gray-500" />
                          </a>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <div className="d-flex justify-content-start flex-column">
                              <a href="#" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
                        ...
                        <td className="text-end pe-12">
                          ...
                          <span className="badge badge-light-danger fs-base">
                            <i className="ki-outline ki-arrow-down fs-5 text-danger ms-n1" />0.4%</span>
                          {/*end::Label*/}
                        </td>
                        <td className="text-end pe-0">
                          <div id="kt_table_widget_15_chart_2" className="h-50px mt-n8 pe-7" data-kt-chart-color="danger" />
                        </td>
                        <td className="text-end">
                          <a href="#" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                            <i className="ki-outline ki-black-right fs-2 text-gray-500" />
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <div className="d-flex justify-content-start flex-column">
                              <a href="#" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
                        ...
                        <td className="text-end pe-0">
                          <div id="kt_table_widget_15_chart_3" className="h-50px mt-n8 pe-7" data-kt-chart-color="success" />
                        </td>
                        <td className="text-end">
                          <a href="#" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                            <i className="ki-outline ki-black-right fs-2 text-gray-500" />
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <div className="d-flex justify-content-start flex-column">
                              <a href="#" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
                        ...
                        <td className="text-end pe-0">
                          <div id="kt_table_widget_15_chart_4" className="h-50px mt-n8 pe-7" data-kt-chart-color="success" />
                        </td>
                        <td className="text-end">
                          <a href="#" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                            <i className="ki-outline ki-black-right fs-2 text-gray-500" />
                      ...
                      <tr>
                        <td>
                          <div className="d-flex align-items-center">
                            ...
                            <div className="d-flex justify-content-start flex-column">
                              <a href="#" className="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
                        ...
                        <td className="text-end pe-0">
                          <div id="kt_table_widget_15_chart_5" className="h-50px mt-n8 pe-7" data-kt-chart-color="danger" />
                        </td>
                        <td className="text-end">
                          <a href="#" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                            <i className="ki-outline ki-black-right fs-2 text-gray-500" />
                  ...
                  <div className="card-body pt-5">
                    ...
                    <div className="d-flex flex-stack">
                      ...
                      <button type="button" className="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end">
                        <i className="ki-outline ki-exit-right-corner fs-2" />
                      </button>
                      {/*end::Action*/}
                    </div>
                    {/*end::Item*/}
                ...
                <div className="card card-flush">
                  ...
                  <div className="card-header pt-7">
                    ...
                    <h3 className="card-title align-items-start flex-column">
                      ...
                      <span className="text-gray-500 mt-1 fw-semibold fs-6">59 Active Shipments</span>
                    </h3>
                    {/*end::Title*/}
                    {/*begin::Toolbar*/}
                    <div className="card-toolbar">
                      <a href="#" className="btn btn-sm btn-light" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-custom-class="tooltip-inverse" title="Logistics App is coming soon">View All</a>
                    </div>
                    {/*end::Toolbar*/}
                  </div>
                  {/*end::Header*/}
                  ...
                  <div className="card-body">
                    ...
                    <ul className="nav nav-pills nav-pills-custom row position-relative mx-0 mb-9">
                      ...
                      <li className="nav-item col-4 mx-0 p-0">
                        {/*begin::Link*/}
                        <a className="nav-link active d-flex justify-content-center w-100 border-0 h-100" data-bs-toggle="pill" href="#kt_list_widget_10_tab_1">
                          {/*begin::Subtitle*/}
                      ...
                      <li className="nav-item col-4 mx-0 px-0">
                        {/*begin::Link*/}
                        <a className="nav-link d-flex justify-content-center w-100 border-0 h-100" data-bs-toggle="pill" href="#kt_list_widget_10_tab_2">
                          {/*begin::Subtitle*/}
                          <span className="nav-text text-gray-800 fw-bold fs-6 mb-3">Delivered</span>
                          {/*end::Subtitle*/}
                          {/*begin::Bullet*/}
                          <span className="bullet-custom position-absolute z-index-2 bottom-0 w-100 h-4px bg-primary rounded" />
                          {/*end::Bullet*/}
                      ...
                      <li className="nav-item col-4 mx-0 px-0">
                        {/*begin::Link*/}
                        <a className="nav-link d-flex justify-content-center w-100 border-0 h-100" data-bs-toggle="pill" href="#kt_list_widget_10_tab_3">
                          {/*begin::Subtitle*/}
                      ...
                      <div className="tab-pane fade show active" id="kt_list_widget_10_tab_1">
                        ...
                        <div className="m-0">
                          ...
                          <div className="d-flex align-items-sm-center mb-5">
                            ...
                            <div className="symbol symbol-45px me-4">
                              <span className="symbol-label bg-primary">
                                <i className="ki-outline ki-ship text-inverse-primary fs-1" />
                              </span>
                            </div>
                            {/*end::Symbol*/}
                            {/*begin::Section*/}
                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                              <div className="flex-grow-1 me-2">
                                <a href="#" className="text-gray-500 fs-6 fw-semibold">Ship Freight</a>
                                <span className="text-gray-800 fw-bold d-block fs-4">#5635-342808</span>
                              </div>
                              <span className="badge badge-lg badge-light-success fw-bold my-2 fs-8">Delivered</span>
                            </div>
                            {/*end::Section*/}
                          </div>
                          {/*end::Wrapper*/}
                          ...
                          <div className="timeline">
                            ...
                            <div className="timeline-item align-items-center mb-7">
                              {/*begin::Timeline line*/}
                              <div className="timeline-line mt-1 mb-n6 mb-sm-n7" />
                              {/*end::Timeline line*/}
                              {/*begin::Timeline icon*/}
                              <div className="timeline-icon">
                                <i className="ki-outline ki-cd fs-2 text-danger" />
                              </div>
                              {/*end::Timeline icon*/}
                              {/*begin::Timeline content*/}
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">Messina Harbor</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                            ...
                            <div className="timeline-item align-items-center">
                              ...
                              {/*begin::Timeline icon*/}
                              <div className="timeline-icon">
                                <i className="ki-outline ki-geolocation fs-2 text-info" />
                              </div>
                              {/*end::Timeline icon*/}
                              {/*begin::Timeline content*/}
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">Hektor Container Hotel</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                        ...
                        <div className="m-0">
                          ...
                          <div className="d-flex align-items-sm-center mb-5">
                            ...
                            <div className="symbol symbol-45px me-4">
                              <span className="symbol-label bg-primary">
                                <i className="ki-outline ki-truck text-inverse-primary fs-1" />
                              </span>
                            </div>
                            {/*end::Symbol*/}
                            {/*begin::Section*/}
                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                              <div className="flex-grow-1 me-2">
                                <a href="#" className="text-gray-500 fs-6 fw-semibold">Truck Freight</a>
                                <span className="text-gray-800 fw-bold d-block fs-4">#0066-954784</span>
                              </div>
                              <span className="badge badge-lg badge-light-primary fw-bold my-2 fs-8">Shipping</span>
                            </div>
                            {/*end::Section*/}
                          </div>
                          {/*end::Wrapper*/}
                          ...
                          <div className="timeline">
                            ...
                            <div className="timeline-item align-items-center mb-7">
                              ...
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">Haven van Rotterdam</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                                <span className="fs-6 fw-bold text-gray-800">Rotterdam, Netherlands</span>
                                {/*end::Title*/}
                              </div>
                              {/*end::Timeline content*/}
                            </div>
                            ...
                            <div className="timeline-item align-items-center">
                              ...
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">Forest-Midi</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                                <span className="fs-6 fw-bold text-gray-800">Brussels, Belgium</span>
                                {/*end::Title*/}
                              </div>
                              {/*end::Timeline content*/}
                            </div>
                        ...
                        <div className="m-0">
                          ...
                          <div className="d-flex align-items-sm-center mb-5">
                            ...
                            <div className="symbol symbol-45px me-4">
                              <span className="symbol-label bg-primary">
                                <i className="ki-outline ki-delivery text-inverse-primary fs-1" />
                              </span>
                            </div>
                            {/*end::Symbol*/}
                            {/*begin::Section*/}
                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                              <div className="flex-grow-1 me-2">
                                <a href="#" className="text-gray-500 fs-6 fw-semibold">Delivery Freight</a>
                                <span className="text-gray-800 fw-bold d-block fs-4">#5635-342808</span>
                              </div>
                              <span className="badge badge-lg badge-light-success fw-bold my-2 fs-8">Delivered</span>
                            </div>
                          ...
                          <div className="timeline">
                            ...
                            <div className="timeline-item align-items-center mb-7">
                              ...
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">Mina St - Zayed Port</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                            ...
                            <div className="timeline-item align-items-center">
                              ...
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">27 Drydock Boston</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                        ...
                        <div className="m-0">
                          ...
                          <div className="d-flex align-items-sm-center mb-5">
                            ...
                            <div className="symbol symbol-45px me-4">
                              <span className="symbol-label bg-primary">
                                <i className="ki-outline ki-airplane-square text-inverse-primary fs-1" />
                              </span>
                            </div>
                            {/*end::Symbol*/}
                            {/*begin::Section*/}
                            <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                              <div className="flex-grow-1 me-2">
                                <a href="#" className="text-gray-500 fs-6 fw-semibold">Plane Freight</a>
                                <span className="text-gray-800 fw-bold d-block fs-4">#5635-342808</span>
                              </div>
                              <span className="badge badge-lg badge-light-danger fw-bold my-2 fs-8">Delayed</span>
                            </div>
                            {/*end::Section*/}
                          </div>
                          {/*end::Wrapper*/}
                          ...
                          <div className="timeline">
                            ...
                            <div className="timeline-item align-items-center mb-7">
                              ...
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">KLM Cargo</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                                <span className="fs-6 fw-bold text-gray-800">Schipol Airport, Amsterdam</span>
                                {/*end::Title*/}
                              </div>
                              {/*end::Timeline content*/}
                            </div>
                            ...
                            <div className="timeline-item align-items-center">
                              ...
                              <div className="timeline-content m-0">
                                {/*begin::Title*/}
                                <span className="fs-6 text-gray-500 fw-semibold d-block">Singapore Cargo</span>
                                {/*end::Title*/}
                                {/*begin::Title*/}
                                <span className="fs-6 fw-bold text-gray-800">Changi Airport, Singapore</span>
                                {/*end::Title*/}
                              </div>
                              {/*end::Timeline content*/}
                            </div>
              ...
              <div className="col-sm-6 col-xl-12 mb-xl-10">
                ...
                <div className="card card-flush">
                  ...
                  <div className="card-header pt-7 mb-3">
                    ...
                    {/*begin::Toolbar*/}
                    <div className="card-toolbar">
                      <a href="#" className="btn btn-sm btn-light" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-custom-class="tooltip-inverse" title="Logistics App is coming soon">Review Fleet</a>
                    </div>
                    {/*end::Toolbar*/}
                  </div>
                  {/*end::Header*/}
                  ...
                  <div className="card-body pt-4">
                    ...
                    <div className="d-flex flex-stack">
                      ...
                      <div className="d-flex align-items-center me-5">
                        ...
                        <div className="symbol symbol-40px me-4">
                          <span className="symbol-label">
                            <i className="ki-outline ki-ship text-gray-600 fs-1" />
                          </span>
                        </div>
                        {/*end::Symbol*/}
                        {/*begin::Content*/}
                      ...
                      <div className="text-gray-500 fw-bold fs-7 text-end">
                        ...
                        {/*end::Number*/}
                        <span className="d-block">Tons</span>
                      </div>
                      {/*end::Wrapper*/}
                    </div>
                    {/*end::Item*/}
                    ...
                    <div className="d-flex flex-stack">
                      ...
                      <div className="d-flex align-items-center me-5">
                        ...
                        <div className="symbol symbol-40px me-4">
                          <span className="symbol-label">
                            <i className="ki-outline ki-truck text-gray-600 fs-1" />
                          </span>
                        </div>
                        {/*end::Symbol*/}
                        {/*begin::Content*/}
                    ...
                    <div className="d-flex flex-stack">
                      ...
                      <div className="d-flex align-items-center me-5">
                        ...
                        <div className="symbol symbol-40px me-4">
                          <span className="symbol-label">
                            <i className="ki-outline ki-airplane-square text-gray-600 fs-1" />
                          </span>
                        </div>
                        {/*end::Symbol*/}
                        {/*begin::Content*/}
                    ...
                    <div className="d-flex flex-stack">
                      ...
                      <div className="d-flex align-items-center me-5">
                        ...
                        <div className="symbol symbol-40px me-4">
                          <span className="symbol-label">
                            <i className="ki-outline ki-bus text-gray-600 fs-1" />
                          </span>
                        </div>
                        {/*end::Symbol*/}
                        {/*begin::Content*/}
                    ...
                    <div className="text-center pt-9">
                      <a href="#" className="btn btn-primary">Add Vehicle</a>
                    </div>
                  </div>
                  {/*end::Body*/}
                </div>
