...
const AppNavbar = () => {
  ...
  useNavbarInteractions(navbarRef);
  ...
  return (
    <div className="app-navbar flex-shrink-0 gap-2 gap-lg-4">
      ...
      <div className="app-navbar-item">
        {/*begin::Menu wrapper*/}
        <div
          className="btn btn-icon border border-200 bg-gray-100 btn-color-gray-600 btn-active-color-primary w-40px h-40px"
          data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
          data-kt-menu-attach="parent"
          data-kt-menu-placement="bottom-end"
        >
          <i className="ki-outline ki-element-11 fs-4" />
        </div>
        {/*begin::My apps*/}
        <div
      ...
      <div className="app-navbar-item">
        ...
        <div
          ...
          id="kt_menu_item_wow"
        >
          <i className="ki-outline ki-notification-status fs-4" />
        </div>
        {/*begin::Menu*/}
        <div
